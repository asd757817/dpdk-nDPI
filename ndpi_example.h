...
#ifdef USE_DPDK
int dpdk_port_id, dpdk_run_capture, sig_called;
#endif
...
void updateTopIpAddress(u_int32_t addr, u_int8_t version, const char *proto, int count, struct info_pair top[], int size);
